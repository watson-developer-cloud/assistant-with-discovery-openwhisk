...
<li>Edit the [actions/conversationParams.json]( https://github.com/chris-anchez/conversation-with-discovery-openwhisk/actions/conversationParams.json ) and [https://github.com/chris-anchez/conversation-with-discovery-openwhisk/actions/discoveryParams.json](discoveryParams.json) to include your usernames, passwords, environment_id's and collection_id for the Conversation and Discovery services (found in Bluemix).</li>
